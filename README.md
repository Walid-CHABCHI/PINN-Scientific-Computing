...
Résolution d'équations aux dérivées partielles et de problèmes inverses par **Physics-Informed Neural Networks (PINNs)**, dans le cadre d'un stage de 8 semaines. L'objectif final est la résolution de problèmes inverses sur des équations intégro-différentielles (RFE).
...
| `02_deepxde_migration/` | Migration vers DeepXDE, optimisation L-BFGS *(à venir)* |
